...
#define	LCD_Backlight_PORT							GPIOC									// 背光 GPIO端口
#define 	GPIO_LDC_Backlight_CLK_ENABLE        	__HAL_RCC_GPIOC_CLK_ENABLE()	// 背光 GPIO时钟 	
...
#define  LCD_DC_PIN						GPIO_PIN_0				         // 数据指令选择  引脚				
#define	LCD_DC_PORT						GPIOC									// 数据指令选择  GPIO端口
#define 	GPIO_LDC_DC_CLK_ENABLE     __HAL_RCC_GPIOC_CLK_ENABLE()	// 数据指令选择  GPIO时钟 	
